-- Update get_program_detail_data to include calendar_link and certificate details
...
BEGIN
  -- 1. Buscar dados do curso com calendar_link
  ...
  -- 8. Verificar certificado com todos os campos necessários
  SELECT jsonb_build_object(
    'id', cert.id,
