...
BEGIN
  ...
  -- 3. Buscar módulos com lições e progresso (incluindo lesson_type e lesson_label)
  ...
  -- 4. Buscar missões semanais com status de conclusão E admin_feedback
  ...
  FROM (
    SELECT 
      jsonb_build_object(
        ...
        'admin_feedback', umc.admin_feedback,
