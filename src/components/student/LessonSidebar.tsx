          ...
          return (
            <div key={module.id}>
              ...
              <button
                ...
                className={cn(
                  "w-full flex items-center justify-between p-4 hover:bg-muted transition-colors text-left",
                  ...
                  {module.lessons.map((lesson, lessonIndex) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "w-full flex items-center gap-3 px-4 py-3 hover:bg-muted transition-all text-left",
