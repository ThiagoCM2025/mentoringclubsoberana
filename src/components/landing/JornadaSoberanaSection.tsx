...
const ProgramCard = ({
  ...
  return <motion.div ref={cardRef} initial={{
    ...
    duration: 0.7,
    delay: index * 0.1
  }} className={`grid md:grid-cols-2 gap-8 md:gap-16 items-center ${isReversed ? "md:grid-flow-dense" : ""}`}>
      {/* Image with Golden Frame */}
      <motion.div className={`relative ${isReversed ? "md:col-start-2" : ""}`} initial={{
      opacity: 0,
      x: isReversed ? 30 : -30
    }} animate={cardInView ? {
      opacity: 1,
      ...
      delay: 0.2
        ...
        <div className="golden-frame group">
          ...
          <div className="golden-frame-inner aspect-[4/5] overflow-hidden">
            <img src={program.image || mentorFabiana} alt={program.title} className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-700" loading="lazy" width={400} height={500} />
      ...
      {/* Content */}
      <motion.div className={`${isReversed ? "md:col-start-1 md:text-right" : ""}`} initial={{
      opacity: 0,
      x: isReversed ? -30 : 30
    }} animate={cardInView ? {
      opacity: 1,
...
export const JornadaSoberanaSection = () => {
  ...
  return <section className="py-16 sm:py-24 md:py-40 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[400px] sm:w-[600px] md:w-[800px] h-[400px] sm:h-[600px] md:h-[800px] opacity-[0.08] sm:opacity-[0.12]" style={{
      backgroundImage: `url(${patternCirclesGold})`,
      backgroundRepeat: 'no-repeat',
      backgroundSize: 'contain',
      backgroundPosition: 'top right'
    }} />
      <div className="absolute bottom-0 left-0 w-[400px] sm:w-[600px] md:w-[800px] h-[400px] sm:h-[600px] md:h-[800px] opacity-[0.08] sm:opacity-[0.12]" style={{
      backgroundImage: `url(${patternCirclesGold})`,
      backgroundRepeat: 'no-repeat',
      backgroundSize: 'contain',
      ...
      <div className="container-soberana relative z-10">
        ...
        duration: 0.7
          ...
          <motion.p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed" initial={{
          opacity: 0
        }} animate={isInView ? {
          opacity: 1
        } : {}} transition={{
        ...
        duration: 0.7
          ...
          <div className="relative">
            ...
            <div className="relative inline-block">
              ...
              <motion.a href="https://wa.me/5511993563468?text=Olá! Quero ajuda para escolher o programa ideal para mim" target="_blank" rel="noopener noreferrer" className="group relative inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-12 py-4 sm:py-6 rounded-xl font-semibold text-sm sm:text-lg tracking-wide overflow-hidden" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.98
            }} animate={{
              boxShadow: ["0 0 20px rgba(166,144,97,0.4)", "0 0 40px rgba(166,144,97,0.6)", "0 0 20px rgba(166,144,97,0.4)"]
            }} transition={{
              boxShadow: {
                duration: 2,
                repeat: Infinity,
                ...
                <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-[shimmer_2s_infinite]" style={{
