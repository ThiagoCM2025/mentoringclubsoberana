...
const ExperienceFAQ = lazy(() => import("@/components/landing/ExperienceFAQ").then(m => ({
  default: m.ExperienceFAQ
})));
const ExperienceTestimonials = lazy(() => import("@/components/landing/ExperienceTestimonials").then(m => ({
  default: m.ExperienceTestimonials
})));
...
const ExperienceStartLanding = () => {
  ...
  const inviteInView = useInView(inviteRef, {
    once: true,
    amount: 0.1
  });
  ...
  return <div className="min-h-screen bg-background landing-page">
      ...
      duration: 0.6
        ...
        <div className="container-soberana py-3 flex items-center justify-between">
          ...
          <Button asChild className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold text-xs md:text-sm px-3 sm:px-4 md:px-6 cta-premium" onClick={() => trackCTAClick("header_cta")}>
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col bg-brand-black">
        ...
        <div className="md:hidden flex flex-col min-h-screen">
          ...
          <div className="relative h-[45vh] w-full overflow-hidden flex-shrink-0">
            <img src={heroImage} alt="" fetchPriority="high" loading="eager" decoding="async" className="w-full h-full object-cover object-[center_20%]" />
          ...
          ease: "easeOut"
            ...
            delay: 0.25
              ...
              label: 'SEG'
            }].map((item, index) => <div key={index} className="text-center bg-primary/60 backdrop-blur-sm rounded-lg px-2 py-1.5 border border-secondary/20">
            ...
            delay: 0.3
              ...
              <Button asChild size="lg" className="w-full cta-premium bg-secondary hover:bg-secondary/90 text-secondary-foreground px-6 py-5 text-sm font-semibold uppercase tracking-wider" onClick={() => trackCTAClick("hero_cta_mobile")}>
        ...
        <div className="hidden md:flex flex-col min-h-screen">
          {/* LQIP Placeholder */}
          <div className="absolute inset-0 z-0 bg-gradient-to-b from-brand-black via-marsala/30 to-brand-black" aria-hidden="true" />
          
          {/* Background Image - Fabiana Premium */}
          <div className="absolute inset-0 z-0" aria-hidden="true">
            <img src={heroImage} alt="" fetchPriority="high" loading="eager" decoding="async" sizes="100vw" className="w-full h-full object-cover object-top" style={{
          ...
          {shouldAnimate && <>
              <motion.img src={isotipoGold} alt="" loading="lazy" className="absolute right-12 top-1/4 w-48 opacity-10 animate-float-slow z-[3]" initial={{
            opacity: 0
          }} animate={heroInView ? {
            opacity: 0.1
          } : {}} transition={{
            ...
            delay: 0.5
              ...
              <motion.img src={isotipoSGold} alt="" loading="lazy" className="absolute left-12 bottom-1/3 w-24 opacity-8 animate-float-slow animation-delay-2000 z-[3]" initial={{
            opacity: 0
          }} animate={heroInView ? {
            opacity: 0.08
          } : {}} transition={{
                ...
                <div className="flex justify-center gap-2 sm:gap-3 md:gap-4">
                  {[{
                    ...
                    label: 'SEG'
                      ...
                      {!isMobile && <div className="absolute -inset-0.5 bg-gradient-to-r from-secondary/50 to-gold-dark/50 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-500" />}
                ...
                <div className="relative">
                  ...
                  {!isMobile && <>
                      <div className="absolute inset-0 -m-3 pointer-events-none">
                        <span className="absolute inset-0 rounded-lg bg-secondary/20 animate-ping" style={{
                        animationDuration: '2s'
                      }} />
                      </div>
                      <div className="absolute inset-0 -m-2 pointer-events-none">
                        <span className="absolute inset-0 rounded-lg bg-secondary/10 animate-ping" style={{
                  ...
                  <Button asChild size="lg" className="relative cta-premium bg-secondary hover:bg-secondary/90 text-secondary-foreground px-4 sm:px-8 md:px-12 py-5 sm:py-6 md:py-7 text-xs sm:text-sm md:text-lg font-bold uppercase tracking-wide group" onClick={() => trackCTAClick("hero_cta")}>
                    <a href={ctaUrl} target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-background relative overflow-hidden">
        ...
        <div className="container-soberana relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
            ...
            icon: Clock,
            label: "HORÁRIO",
            value: "09H00 às 17H00",
            sublabel: "Pausa de 1H30 para almoço"
          }, {
            icon: MapPin,
            label: "LOCAL",
            value: "Espaço Mind",
            sublabel: "R. Abílio Soares, 607 - Paraíso, SP"
      ...
      <section ref={problemRef} className="py-16 md:py-24 lg:py-28 bg-brand-black relative overflow-hidden">
        ...
        {shouldAnimate && <>
            <motion.img src={isotipoGold} alt="" loading="lazy" className="absolute right-4 md:right-8 top-16 w-32 md:w-40 opacity-[0.12] animate-float-slow hidden sm:block" initial={{
          opacity: 0
          ...
          delay: 0.6
            ...
            <motion.img src={isotipoSGold} alt="" loading="lazy" className="absolute left-4 bottom-8 w-20 md:w-24 opacity-[0.10] animate-float-slow animation-delay-1000 hidden sm:block" initial={{
          opacity: 0
        }} animate={problemInView ? {
          opacity: 0.10
        } : {}} transition={{
        ...
        <div className="container-soberana relative z-10">
          ...
          duration: 0.8
            ...
            <div className="space-y-4 md:space-y-6">
              {["A maior barreira da advogada não é o mercado. É o que ela acredita sobre si mesma.", "Produtividade não é correr. É fazer o básico muito bem feito."].map((quote, index) => <motion.div key={index} initial={{
              opacity: 0,
              x: index % 2 === 0 ? -20 : 20
            }} animate={problemInView ? {
              opacity: 1,
      ...
      <section ref={experienceRef} className="py-14 sm:py-20 md:py-28 bg-background relative overflow-hidden">
        ...
        {!isMobile && <>
            <img src={isotipoGold} alt="" loading="lazy" className="absolute left-4 top-20 w-28 opacity-5 animate-float-slow hidden sm:block" />
            <img src={isotipoSGold} alt="" loading="lazy" className="absolute right-8 bottom-20 w-20 opacity-5 animate-float-slow animation-delay-2000 hidden sm:block" />
          </>}
        ...
        <div className="container-soberana relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
            {programContent.map((item, index) => <motion.div key={index} initial={{
            opacity: 0,
            y: 30
          }} animate={experienceInView ? {
            opacity: 1,
      ...
      <section ref={inviteRef} className="py-14 sm:py-20 md:py-28 bg-brand-black relative overflow-hidden">
        ...
        {/* Decorative isotipos - desktop only */}
        {shouldAnimate && <>
            <motion.img src={isotipoGold} alt="" loading="lazy" className="absolute right-8 top-16 w-32 sm:w-40 opacity-[0.10] animate-float-slow hidden sm:block" initial={{
          opacity: 0
        }} animate={inviteInView ? {
          opacity: 0.1
        } : {}} />
            <motion.img src={isotipoSGold} alt="" loading="lazy" className="absolute left-8 bottom-16 w-20 sm:w-24 opacity-[0.12] animate-float-slow animation-delay-1000 hidden sm:block" initial={{
          opacity: 0
        }} animate={inviteInView ? {
          opacity: 0.12
        } : {}} />
        ...
        <div className="container-soberana relative z-10">
          ...
          duration: 0.8
            ...
            <motion.img src={isotipoGold} alt="" className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-6 sm:mb-8 isotipo-glow" initial={{
            scale: 0
          }} animate={inviteInView ? {
            scale: 1
          } : {}} transition={{
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-8 sm:mb-12">
              {["A prática vence o medo.", "A constância vence a comparação."].map((quote, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} animate={inviteInView ? {
              opacity: 1,
            ...
            delay: 0.9
              ...
              <Button asChild size="lg" className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold text-sm sm:text-lg w-full sm:w-auto px-6 sm:px-10 py-5 sm:py-7 rounded-lg shadow-2xl hover:shadow-secondary/30 transition-all group cta-premium whitespace-normal text-center leading-tight flex-wrap justify-center" onClick={() => trackCTAClick("invite_cta")}>
                <a href={ctaUrl} target="_blank" rel="noopener noreferrer">
              ...
              <div className="golden-frame">
                ...
                <div className="golden-frame-inner bg-card p-8 md:p-12 text-center">
                  ...
                  <ul className="text-left max-w-sm mx-auto mb-8 space-y-3">
                    {["8 horas de oficina presencial", "Material de apoio exclusivo", "Plano de 90 dias personalizado", "Networking com advogadas", "Coffee break incluso"].map((item, index) => <li key={index} className="flex items-center gap-3 text-foreground">
                  ...
                  <div className="relative">
                    <div className="absolute inset-0 -m-4 pointer-events-none">
                      <span className="absolute inset-0 rounded-lg bg-primary/20 animate-ping" style={{
                      animationDuration: '2s'
                    }} />
                    </div>
                    <div className="absolute inset-0 -m-3 pointer-events-none">
                      <span className="absolute inset-0 rounded-lg bg-primary/10 animate-ping" style={{
                      animationDuration: '2.5s',
                      animationDelay: '0.5s'
                    }} />
                    </div>
                    
                    <Button asChild size="lg" className="relative w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-sm sm:text-base md:text-lg py-6 sm:py-7 h-auto rounded-lg shadow-2xl hover:shadow-primary/30 transition-all group whitespace-normal text-center leading-tight flex-wrap justify-center" onClick={() => trackCTAClick("pricing_cta")}>
                      <a href={ctaUrl} target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-16 md:py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container-soberana relative z-10 text-center">
          ...
          once: true
            ...
            <motion.img src={isotipoGold} alt="Soberana" className="w-14 h-14 mx-auto mb-6 isotipo-glow" whileHover={{
            scale: 1.1
          }} />
